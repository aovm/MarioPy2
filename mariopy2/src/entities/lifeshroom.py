...
class LifeShroom(MovableObject):
    
    def __init__(self, pos: tuple, event_bus, data="") -> None:
        super().__init__((12, 13), pos, event_bus,id=c.L_SHROOM, data=data, x_offsets=(2, 2), y_offsets=(3, 0))
    ...
    def texture(self, game_res: dict): return game_res['objects']['shroom_1-up']['1']
    ...
    def lifeshroomEvent(self, dt: float) -> None:
